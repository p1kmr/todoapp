					...
					<c:forEach items="${todos }" var="t">
						<div class="card">
							<div class="card-body">
								...
								<a href='<c:url value='delete/${t.todoId}'></c:url>' class="btn btn-primary">Delete</a>
								<a href='<c:url value='update/${t.todoId}'></c:url>' class="btn btn-primary">Update</a>
